#!/usr/bin/env python3
"""Speaker Identification System using Unsloth for Fine-tuning"""
...
class SpeakerIdentifierUnsloth:
    def __init__(self, model_name="microsoft/DialoGPT-medium", max_seq_length=512):
    ...
    def setup_model(self, num_labels):
        """Setup Unsloth model for fine-tuning"""
        print(f"🔧 Setting up Unsloth model: {self.model_name}")
    ...
    def train_model(self, training_data, epochs=3, batch_size=4, learning_rate=2e-4):
        """Train the speaker identification model using Unsloth"""
        ...
        training_args = TrainingArguments(
            output_dir="./speaker_identification_model",
...
def test_unsloth_speaker_identification():
    """Test the Unsloth-based speaker identification system"""
    print("🧪 Testing Unsloth Speaker Identification System")
    print("=" * 60)
...
if __name__ == "__main__":
    test_unsloth_speaker_identification() 